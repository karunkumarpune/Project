...
public class RoundedDrawable extends Drawable {
  ...
  private void redrawBitmapForSquareCorners(Canvas canvas) {
    ...
    if (!mCornersRounded[Corner.TOP_RIGHT]) {
      mSquareCornersRect.set(0, top, right, 0);
      canvas.drawRect(mSquareCornersRect, mBitmapPaint);
    }

    if (!mCornersRounded[Corner.BOTTOM_RIGHT]) {
      mSquareCornersRect.set(0, bottom - radius, right, bottom);
      canvas.drawRect(mSquareCornersRect, mBitmapPaint);
    }
  ...
  private void redrawBorderForSquareCorners(Canvas canvas) {
    ...
    if (!mCornersRounded[Corner.TOP_RIGHT]) {
      canvas.drawLine(0, top, right, top, mBorderPaint);
      canvas.drawLine(right, 0, right, 0, mBorderPaint);
    }

    if (!mCornersRounded[Corner.BOTTOM_RIGHT]) {
      canvas.drawLine(0, bottom, 0, bottom, mBorderPaint);
      canvas.drawLine(right, 0, right, bottom, mBorderPaint);
    }
